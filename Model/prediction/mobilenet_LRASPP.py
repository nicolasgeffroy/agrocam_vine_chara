...
class LRASPP(nn.Module):
    ...
    def __init__(
        self, backbone: nn.Module, low_channels: int, high_channels: int, num_classes: int, classif: bool = False, inter_channels: int = 128, 
    ) -> None:
        super().__init__()
...
def _lraspp_mobilenetv3(backbone: MobileNetV3, num_classes: int, classif: bool = False) -> LRASPP:
    ...
    return LRASPP(backbone, low_channels, high_channels, num_classes, classif)
...
def lraspp_mobilenet_v3_large(
    ...
    **kwargs: Any,
    ...
    model = _lraspp_mobilenetv3(backbone, num_classes, classif)
